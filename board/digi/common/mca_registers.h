...
#define MCA_CC6UL_PWR_BUT_DEBOUNCE	0x002a
#define MCA_CC6UL_PWR_BUT_DELAY		0x002b
#define MCA_CC6UL_PWR_BUT_GUARD		0x002c
...
#define MCA_CC6UL_TAMPER0_DATE_START	0x003c
...
#define MCA_CC6UL_PWROFF_BOOT_DURATION	0x0055
#define MCA_CC6UL_RESET_DEASSERT_DELAY	0x0056
...
#define MCA_CC6UL_TAMPER_DATE_LEN	(MCA_CC6UL_TAMPER0_EVENT - \
					 MCA_CC6UL_TAMPER0_DATE_START)

#define MCA_CC6UL_TAMPER_DATE_OFF	(MCA_CC6UL_TAMPER0_DATE - \
					 MCA_CC6UL_TAMPER0_CFG0)

#define MCA_CC6UL_TAMPER_CFG0_OFFSET	(MCA_CC6UL_TAMPER0_CFG0 - \
					 MCA_CC6UL_TAMPER0_CFG0)

#define MCA_CC6UL_TAMPER_EV_OFFSET	(MCA_CC6UL_TAMPER0_EVENT - \
					 MCA_CC6UL_TAMPER0_CFG0)
...
/* MCA_CC6UL TAMPER CFGn (addr=0x0037 && addr 0x0046) */
#define MCA_CC6UL_TAMPER_DET_EN		BIT(0)

/* MCA_CC6UL TAMPER EVENT (addr=0x0045) */
