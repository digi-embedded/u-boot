...
const struct stm32key stm32mp21_list[] = {
	...
	{
		.name = "FSBLM-M33-FW-PKH",
		.desc = "Hash of the Public Key for M33TDCID M33 Firmware",
		.start = 188,
		.size = 8,
		.key_format = format2,
	},
	{
		.name = "FSBLM-DDR-FW-PKH",
		.desc = "Hash of the Public Key for M33TDCID DDR Firmware",
		.start = 196,
		.size = 8,
		.key_format = format2,
	},
	{
		.name = "FSBLM-A35-FW-PKH",
		.desc = "Hash of the Public Key for M33TDCID A35 bare metal Firmware",
		.start = 204,
		.size = 8,
		.key_format = format2,
	},
	...
	{
		.name = "TFM-IAK",
		.desc = "Trusted firmware M Initial Attestation Key",
		.start = 340,
		.size = 8,
		.key_format = format2,
	},
