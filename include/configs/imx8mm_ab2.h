...
#define JAILHOUSE_ENV \
	"jh_clk= \0 " \
	"jh_mmcboot=mw 0x303d0518 0xff; setenv fdtfile imx8mm-ab2-root.dtb;" \
		"setenv jh_clk clk_ignore_unused mem=1340MB; " \
			   "if run loadimage; then " \
				   "run mmcboot; " \
			   "else run jh_netboot; fi; \0" \
	"jh_netboot=mw 0x303d0518 0xff; setenv fdtfile imx8mm-ab2-root.dtb; setenv jh_clk clk_ignore_unused mem=1340MB; run netboot; \0 "
