...
#define GD_FLG_DISABLE_CONSOLE_OUTPUT	0x00080	/* Disable console (out)*/
#define GD_FLG_ENV_READY		0x00100	/* Env. imported into hash table */
#define GD_FLG_SERIAL_READY		0x00200	/* Pre-reloc serial console ready */
#define GD_FLG_FULL_MALLOC_INIT	 	0x00400	/* Full malloc() is ready */
